...
import GraficoCobertura from "../../components/graficos/GraficoCobertura";
import GraficoNivelSocioeconomico from "../../components/graficos/GraficoNivelSocioeconomico";
import {
  getHeatmapZonas,
  getEvolucionPadi,
